...
<body>
    <div id="container">
        ...
        <div id="main"><center><b><br/><?= $message ?><br/><br/><br/></b></center></div>
        <br/>&nbsp;<br/>
        <div id="botbar">
            <p><a href = "https://curis.stanford.edu">CURIS Home</a><br>For website problems contact <a href="mailto:llao@cs.stanford.edu">action@cs.stanford.edu</a>
        </div>
    </div>
</body>
</html>